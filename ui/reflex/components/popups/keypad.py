...
class Keypad(Popup):
    ...
    def __init__(self, **kwargs):
        ...
        row1.add_widget(KeypadButton(text="7",on_release=self.add_text))
        row1.add_widget(KeypadButton(text="8",on_release=self.add_text))
        row1.add_widget(KeypadButton(text="9",on_release=self.add_text))
        row1.add_widget(KeypadIconButton(text="\uf55a",on_release=self.delete_text))
        layout.add_widget(row1)

        row2 = BoxLayout(orientation="horizontal")
        row2.add_widget(KeypadButton(text="4",on_release=self.add_text))
        row2.add_widget(KeypadButton(text="5",on_release=self.add_text))
        row2.add_widget(KeypadButton(text="6",on_release=self.add_text))
        ...
        row4.add_widget(KeypadButton(text="0",on_release=self.add_text))
        if not self.integer:
            row4.add_widget(KeypadButton(text=".",on_release=self.dot_key))
        else:
            row4.add_widget(KeypadButton(text="00",on_release=self.add_text))
        row4.add_widget(KeypadIconButton(text="\uf00d",on_release=self.cancel,color=self.app.formats.cancel_color))
        row4.add_widget(KeypadIconButton(text="\uf00c",on_release=self.confirm,color=self.app.formats.accept_color))
